    ...
    return (
        <div className="bg-white border border-gray-200 rounded-xl shadow-md p-4 flex flex-col items-center hover:shadow-lg transition duration-300">
            ...
            <a
                ...
                className="mt-3 inline-block text-sm font-medium text-white bg-cyan-800 hover:bg-cyan-700 px-4 py-2 rounded-md transition shadow-sm transform hover:scale-105"
            >
                Read Now
            </a>
